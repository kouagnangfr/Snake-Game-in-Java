package Kouagangfr.JAVA.SnakeGame;
...
public class GamePanel extends JPanel implements ActionListener {
    ...
    public void gameOver(Graphics g) {
        ...
        g.setColor(Color.white);
        g.setFont(new Font("Ink Free", Font.BOLD, 40));
        g.drawString("Score: " + appleEaten, (SCREEN_WIDTH - metrics.stringWidth("Score: " + appleEaten)) / 2, SCREEN_HEIGHT / 2);

        // Create a Replay button
        JButton replayButton = new JButton("Replay");
        replayButton.setFont(new Font("Ink Free", Font.BOLD, 30));
        replayButton.setBounds((SCREEN_WIDTH - 200) / 2, SCREEN_HEIGHT / 2 + 100, 200, 50);
